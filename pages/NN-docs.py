...
st.markdown(f'''1️⃣ Data Preparation
...
✅ Dataset Collection: The dataset contains thousands of images spanning multiple sports categories.
...
2️⃣ Theory Behind the Algorithm
...
5️⃣ Conclusion
This project successfully developed a sports classification web app using EfficientNetB0. The model achieved high accuracy (98.4%) and demonstrated effective performance in recognizing various sports. The web app provides an interactive and user-friendly interface for real-time predictions.

💡 Future Improvements:

Implement ResNet50 as an alternative model.
Deploy on a cloud platform for wider accessibility.
